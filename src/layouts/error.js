function Icon({ code }) {
  return (
     <svg xmlns="http://www.w3.org/2000/svg"
          ...
          height={150}
          fill="currentColor"
          className="figure-img d-block mx-auto"
          viewBox="0 0 16 16">
      {code === 404 ? (<>
...
export default function Error({ code = 404 }) {
  return (
    <figure className="figure text-secondary position-absolute top-50 start-50 translate-middle">
     <Icon code={code} />
     <figcaption className="figure-caption text-center fs-3">
      {code === 404 ? "No such page." : "Could not fetch the data."}
     </figcaption>
    </figure>
  );
}
